...
import { Plus, Briefcase, MessageSquare, Clock, ArrowRight, CheckCircle, TrendingUp, Zap } from 'lucide-react';
            ...
            {userProjects.length > 0 ? (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                {userProjects.map((project) => (
                  <div 
                    key={project.id}
                    className="bg-white rounded-xl border border-gray-100 hover:shadow-md transition-shadow duration-300 overflow-hidden"
                  >
                    <ProjectCard
                      project={project}
                      showActions={true}
              ...
              <div className="space-y-4">
                {messages.slice(0, 3).map((message) => {
                  ...
                  return (
                    <div 
                      key={message.id} 
                      className="bg-white border border-gray-100 rounded-xl p-4 hover:shadow-md transition-shadow duration-300"
                    >
