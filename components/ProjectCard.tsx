...
export default function ProjectCard({ 
  ...
  return (
    <div className={cn(
      'group bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-100 shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden h-full flex flex-col transform hover:-translate-y-1',
      'hover:border-emerald-100 relative overflow-visible',
      'before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/80 before:to-emerald-50/30 before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-300 before:-z-10',
      className
    )}>
      <div className="p-6 flex-1 flex flex-col min-w-0">
        ...
        <div className="flex justify-between items-start mb-5">
          <div className="flex-1 min-w-0">
            <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800 mb-2">
              {project.status?.replace(/_/g, ' ') || 'Active'}
            </div>
            <h3 className="text-xl font-bold text-gray-900 group-hover:text-emerald-700 transition-colors duration-300 line-clamp-2">
              {project.title}
            </h3>
