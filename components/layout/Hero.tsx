    ...
    <div className="bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-5">
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center bg-white/80 p-4 rounded-xl border border-gray-100 hover:shadow-md transition-shadow duration-300">
      ...
      <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Ready for your source code?</h2>
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of satisfied clients who trust us with their source code
          </p>
          <button 
            onClick={handleGetStarted}
